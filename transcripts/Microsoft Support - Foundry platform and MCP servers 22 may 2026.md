...
So, with the, we still missing, we are waiting for someone else, Emma Vincent, do you know?
576072292608
Vincent Rouet   1:11
Okay.
I think Ha was going to join. I was going to say Mike, but Mike is here.
576072292608
Mike Agar   1:23
Hello.
576072292608
...
I don't have Ha.
And I didn't get a response from Ha.
576072292608
Vincent Rouet   1:39
...
576072292608
Mike Agar   1:54
You are the sole representative from Microsoft, Vincent, so we're going to put you on the spot now, by the sounds of it.
576072292608
Emma Sun   1:57
Ha.
576072292608
...
On the foundry.
576072292608
Sourabh Sardesai   2:18
Yeah, so.
576072292608
Mike Agar   2:18
Well, yeah, I mean, I'll hand over to you as quickly as I can, Emma, really, because you're probably better to explain what the focus is. But the idea of the meeting really, I think, was fundamentally Foundry.
576072292608
Emma Sun   2:24
Mhm.
576072292608
Mike Agar   2:30
How are we doing in MCP servers? Are we having lots or fewer? Is it one API per server, et cetera? MCP versus toolbox. And then within Foundry, how are we structuring agents within Foundry specifically about domains, which I think might be more what you might be able to help us with, Vincent. So maybe we can at least.
576072292608
Vincent Rouet   2:45
Yeah, so that will be my part. How I could join Gemma on the MMC. Yeah.
576072292608
Mike Agar   2:52
If we can at least start with that bit then and see whether we can make progress with you on the domain part, Emma. But I guess I'll hand over to you, Emma, to kind of.
talk about what you want to get out of this and get us started if we can with just Vincent.
576072292608
Emma Sun   3:06
Yeah, for me, for the goal of SCOE this week, I really want to get the approach on tool registry and MCP aligned like by today. But I mean, if Vincent's special expertise is in segregation, then by all means we should start there. So.
Vincent, let us know which topic you think you can provide us more guidance on.
576072292608
Vincent Rouet   3:30
Yeah.
...
576072292608
Emma Sun   3:49
No worries, like Vincent, if you want to start with segregation, and that's the area that you have more focus on, you can start there.
576072292608
Vincent Rouet   3:51
Yeah.
576072292608
...
576072292608
Emma Sun   4:00
Oh, okay, okay, awesome. All right, let's talk about MCP then. Ha Ha.
576072292608
Vincent Rouet   4:03
Okay.
Ha, just thank you for.
joining. Yeah, we were just going through both the agenda for today, and I think the main interest seems to be around the MCP conversation. So I think that's what Emma would like to get clarity on. So how if you're
576072292608
Emma Sun   4:21
Mhm.
Sure.
Yeah, I can, I can give an intro on how currently we are thinking about MCP, like from McKenzie and, and then Sarah, Pankaj, Mike, Jordan, feel free to voice your opinion as well, and then, of course, Ha and Vincent keep us chat dot what we discussed is the best practice. Also, I want to hear you guys.
576072292608
Vincent Rouet   4:30
If you can start.
576072292608
...
576072292608
Mike Agar   4:52
Is that okay, Vincent? Sorry, I realize. Oh, you've just joined and you're being sort of pounced on. Are we all good? Happy with that?
576072292608
Emma Sun   4:58
Hmm.
576072292608
...
mighty will have a lot of agents with a lot of tools and we will want a way to systemize, categorise those tools. And after we do the categorization, the group of tools should be wrapped as FCP server so that we can leverage the benefits of MCP, right? For example, like the tool functionality will be better described to the agent.
there is input validation, the tools will be dynamically exposed to the agent. Like also like, yes.
576072292608
Sourabh Sardesai   6:20
But.
...
576072292608
Sourabh Sardesai   9:53
Okay, good. Sorry. Emma here. Sorry, I cut you.
576072292608
Emma Sun   9:54
Okay.
No, no, Ha, go ahead.
...
576072292608
Pankaj Arora   15:34
Yeah, so what we are saying is for deterministic step, Emma, when we are doing a workflow, we can call directly the API. We don't have to create an MCP server for those APIs.
576072292608
Emma Sun   15:35
Okay, babe.
...
576072292608
Emma Sun   18:03
But yeah, and also even going back to the definition that Sourabh was mentioning, even when we define all the tools to be an API, what we want to propose is like those APIs in APP should be also wrapped in MCP server to just like.
...
576072292608
Emma Sun   18:45
To agent, and that I agree with you, so we will use toolbox as an additional layer, yeah, across as a MCP server gateway, but I think let me just cheque with Pankaj and Sourabh for the part that we want the API APP to be wrapped.
576072292608
...
Not sure we can see it. I'm sorry, I hijacked Mike for a bit. Your diagram is better than me.
576072292608
Emma Sun   20:25
Yeah.
576072292608
...
576072292608
Emma Sun   25:24
Yeah, thanks, Ha. I think we won't do one-to-one mapping for sure, because like building one MCP server just for one tool, that's not mining the full potential of MCP. Like we should always group the tools in based on functionality or the way that was about for use case.
...
True.
576072292608
Sourabh Sardesai   28:36
Blocked.
576072292608
Emma Sun   28:37
So, Sourabh, we're just saying like deploy MCP server in a container is adding more complexity to the picture. Is that what you're saying?
576072292608
Sourabh Sardesai   28:45
...
576072292608
Sourabh Sardesai   29:22
But the question is...
Yeah, yeah, but APP does give you MCP server, like just like Ha said, right? So all those API endpoints can be easily converted into a MCP server, a group of them, of course, for example.
And we can just use it because it does all the scaling and everything.
576072292608
Mike Agar   29:44
So, so when we said that you can just turn on an APP API and it and it can be exposed via MCP, is that what you're saying, Sourabh? And can you do that by group so we don't have the problem of one-to-one?
576072292608
Emma Sun   29:45
Okay.
576072292608
Sourabh Sardesai   29:45
Right.
Yes.
Yeah, of course. Yeah, yeah.
576072292608
Emma Sun   29:56
Are we sure about that? Because I think what Ha was saying, the current functionality is 1 to one.
576072292608
...
Yeah.
Ha.
Give me an example, like an endpoint, let's say, let's say, let's say an endpoint like get, I'm not sure is Mighty publicly IPO yet, but let's say Microsoft SharePoint, Microsoft share price, right? So that's an endpoint, right? So I have a MCP server for stock, and I would have an endpoint for a tool in to get a particular stock for a particular.
...
Mm.
576072292608
Sourabh Sardesai   44:08
Yeah.
576072292608
Ha Duong   44:11
Yeah, that could be an option if you want to reuse it at some point.
576072292608
Sourabh Sardesai   44:11
And.
576072292608
Emma Sun   44:12
Mmh.
576072292608
Sourabh Sardesai   44:13
Ha.
...
576072292608
Emma Sun   44:27
I, yeah, that's a direction that I'm pushing for the ToolsOrToys. Do you have any concerns, Sourabh?
576072292608
Sourabh Sardesai   44:32
So...
576072292608
Pankaj Arora   44:34
No, I think it makes sense that we go via NCP for all the tools.
576072292608
Sourabh Sardesai   44:38
I don't feel that. I don't feel that it should be always MCP. But yeah.
576072292608
Mike Agar   44:44
Why not, Sourabh?
576072292608
Sourabh Sardesai   44:47
Um...
...
Emma Sun   45:00
Just.
So, Sourabh, we are saying, what about this tool is just like one single standalone tool that we don't want it to group with anything.
576072292608
Sourabh Sardesai   45:07
Yeah, yeah.
...
576072292608
Mike Agar   45:57
And you're right, Sourabh, we might argue that in this case where it's a really specific thing and it's only one API and it'll never grow any further, maybe MCP is not really worth it, but as a principle.
576072292608
Emma Sun   45:57
And.
576072292608
...
576072292608
Emma Sun   48:20
Okay, so back to our solution approach, I think we are more or less aligned, to be honest. I think what Mike has here, enpepsulate most of it, and then we'll add another layer on top, which is toolbox. And for Sourabh, I think for a scenario that you mentioned, like, let's say we really have the case that we only have one tool, we don't really need it.
...
576072292608
Ha Duong   49:47
Oh, okay. Because we're recording, because we're recording, I would like to say out loud, APP is a brilliant tool. I disclaim what Sourabh was saying. I still want to keep my jobs. No, what I'm saying is, no, there is many way for you to implement the MCP server in the Microsoft ecosystem. Obviously, APP work quite well.
576072292608
Sourabh Sardesai   49:47
Yeah.
Ha.
576072292608
...
576072292608
Sourabh Sardesai   52:59
Good thing, right?
576072292608
Ha Duong   53:19
Sorry, Vincent, shut up now.
576072292608
Vincent Rouet   53:20
...
You know.
handling concerns around authorizations, implementing policies in front of the endpoints, managing the endpoints, auditing, tracking, blocking, right? So I agree with Sourabh. API management should be in place to front all these MCP endpoints. The other point I wanted to make is
...
Is.
576072292608
Sourabh Sardesai   57:15
Makes sense.
576072292608
Mike Agar   57:17
It does. So where have we got to, Emma? I feel like I feel like I've gone backwards personally. Not backwards in a bad way, but more questions than I thought we had almost. Are you thinking the same or am I over?
576072292608
Ha Duong   57:18
Yes.
576072292608
...
576072292608
Sourabh Sardesai   58:00
Yeah.
576072292608
Mike Agar   58:02
Yeah.
But that's fine. I think so. I think we're all good with that stuff. I'm still keen that the principle is we use MCP and if we're not using MCP, it's a we agree as it's an exception. Sourabh, right? So in theory, use MCP if there's an example.
576072292608
Emma Sun   58:05
Yeah.
Yeah.
...
576072292608
Vincent Rouet   58:30
So, but Mike, when you say not using MMC.
...
576072292608
Mike Agar   59:17
I think what I'm hearing, Ha, you're saying is that really, the less APIs you expose, the better to two agents, because that's all complexity, it's all context window, it's all stuff they're going to get wrong eventually. So keep this as efficient as possible.
576072292608
Ha Duong   59:33
Yep.
576072292608
...
576072292608
Mike Agar   59:47
I'm then hearing that we have a choice to make, right? Are we doing the MMC of these APIs that are now made efficient? So the efficient APIs, are we exposing them directly from a PIM through a function app, or are we what I think is the approach you've suggested, Emma, which is servers?
576072292608
...
576072292608
Sourabh Sardesai   1:01:05
No, no, so.
So, I think, I think, I think what Emma and Francisco is telling is that we need to use a custom fast MCP protocol as a server and host that custom code server on container and expose it and use those as a as a server.
576072292608
Vincent Rouet   1:01:12
Think.
576072292608
Ha Duong   1:01:32
Yeah.
576072292608
Sourabh Sardesai   1:01:33
...
576072292608
Ha Duong   1:02:06
Yeah, do apologize. I got to jump out. Any question before I disappear? If not, then I'll follow Vincent and Vincent can steer me if needed.
576072292608
Mike Agar   1:02:09
Yeah, it works.
576072292608
Sourabh Sardesai   1:02:10
Nice.
576072292608
Vincent Rouet   1:02:18
Yeah, I can do too.
576072292608
Ha Duong   1:02:20
...
576072292608
Sourabh Sardesai   1:06:09
What?
Yeah.
Yeah, so I'm...
576072292608
Vincent Rouet   1:06:19
Exactly.
576072292608
Sourabh Sardesai   1:06:20
I am.
...
576072292608
Emma Sun   1:06:35
So, Francisco, I think what Sourabh is telling us is like, APP has its own way to expose.
576072292608
...
576072292608
Sourabh Sardesai   1:07:25
Yeah.
576072292608
Francisco Cachado   1:07:25
Ha.
576072292608
Sourabh Sardesai   1:07:27
Gareth.
576072292608
Francisco Cachado   1:07:27
Is he?
576072292608
Sourabh Sardesai   1:07:29
Yeah.
576072292608
Emma Sun   1:07:32
...
I think...
576072292608
Sourabh Sardesai   1:08:18
Yeah, but we can.
So, APP can also do a bypass here, so the reason I'm pushing for APP is that everything stays in one place, all the APIs, because there's that's a standard tool which we have been always using within mighty, right? The APP is our standard API gateway, so that's the reason I was pushing.
576072292608
Mike Agar   1:08:28
Correct.
Yeah.
...
576072292608
Mike Agar   1:10:00
Well, I think that's where we are now, Vincent. I think that's where the guys are.
576072292608
Emma Sun   1:10:00
Ha.
576072292608
Vincent Rouet   1:10:02
...
Mayes.
576072292608
Vincent Rouet   1:10:43
Yeah.
576072292608
Francisco Cachado   1:10:45
Yeah, I think you, you.
